                    ...
                    <table class="table border-0 text-left table-borderless">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @include('includes.purchases.stars', ['stars' =>
                                    (int)$product->avgRate('quality_rate')])
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        ...
                                        <li>
                                            <strong>@include('includes.currency', ['usdValue' => $offer ->
                                                dollars])</strong> per {{ str_plural($product -> mesure, 1) }},
                                            for at least {{ $offer -> min_quantity }}
                                            {{ str_plural('product', $offer -> min_quantity) }}
                                        </li>
                                        @endforeach
                                    </ul>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span
                                        class="badge badge-indigo">{{ strtoupper(\App\Purchase::coinDisplayName($coin)) }}</span>
                                    @endforeach
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-light">{{ $product -> quantity }}
                                        {{ str_plural($product -> mesure, $product -> quantity) }}</span>/
                                    <span class="badge badge-light">{{ $product -> orders }}
                                        {{ str_plural($product -> mesure, $product -> orders) }} </span>
                                </td>
                                @endif
                            </tr>
                            <tr>
                                <td colspan="2">
                                    @if($product->user->vendor->experience < 0) <p
                                        class="text-danger border border-danger rounded p-1 mt-2"><span
                                            class="fas fa-exclamation-circle"></span> Negative experience, trade with
                                        caution!
                                        </p>
                                        @endif
                                </td>
                            ...
                            <tr class="bg-light">
                                ...
                                <td>
                                    ...
                                    <span
                                        class="badge badge-mblue">{{ strtoupper(\App\Purchase::coinDisplayName($product -> getCoins()[0])) }}</span>
                            ...
                            <tr class="bg-light">
                                ...
                                <td>
                                    ...
                                    <span
                                        class="badge badge-mblue">{{ \App\Purchase::$types[$product -> getTypes()[0]] }}</span>
                            ...
                            <tr class="bg-light">
                                ...
                                <td class="row">
                                    <div class="col-md-5">
                                        <input @if(!$product -> isUnlimited()) style="display: none;" @endif type="number" min="1" name="amount" id="amount" value="1"
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <a href="{{ route('profile.wishlist.add', $product) }}"
                                            class="btn btn-outline-secondary btn-block btn-sm"><i
                                                class="far fa-heart"></i> Remove
                                            from
                                            wishlist</a>
                                        @else
                                        <a href="{{ route('profile.wishlist.add', $product) }}"
                                            class="btn btn-sm btn-block btn-outline-danger"><i class="fas fa-heart"></i>
                                            Add to wishlist</a>
                                        @endif
                                        @endauth
                                    </div>
    ...
    <div class="col-md-3">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <hr>
                <a href="{{ route('profile.messages').'?otherParty='.$product -> user ->username}}"
                    class="btn mb-1 btn-outline-secondary"><span class="fas fa-envelope"></span> Send message</a>
                <a href="{{route('search',['user'=>$product->user->username])}}"
                    class="btn mb-1 btn-outline-info">Seller's products ({{$product -> user ->products()->count()}})</a>
